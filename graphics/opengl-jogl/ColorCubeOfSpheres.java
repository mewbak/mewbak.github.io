 ...
 */
public class ColorCubeOfSpheres extends JPanel implements GLEventListener {

	public static void main(String[] args) {
		JFrame window = new JFrame("Color Cube of Spheres");
	...
	private JComboBox renderModeSelect; // For selecting the type of rendering
	...
	public ColorCubeOfSpheres() {
		renderModeSelect = new JComboBox();
		...
		message = new JLabel("Render time:");
	...
	public void init(GLAutoDrawable drawable) {
		...
		TexturedShapes.uvSphere(gl, 0.4, 32, 16, false);
		gl.glEndList();
	...
	public void display(GLAutoDrawable drawable) {
		...
		for (int i = 0; i <= 10; i++) {
			...
			for (int j = 0; j <= 10; j++) {
				...
				for (int k = 0; k <= 10; k++) {
					...
					if (mode == 0)
						TexturedShapes.uvSphere(gl, 0.4, 32, 16, false);  // Draw sphere directly.
					else if (mode == 1)
		...
		message.setText("Render Time: " + time);
	}
