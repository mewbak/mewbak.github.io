...
public class SceneGraphAPI2D extends JPanel {
   ...
   private void createWorld() {
       ...
       sunTemp.setColor(Color.YELLOW); // color for filled circle and light rays
       ...
       sunTemp.add( new TransformedObject(circle).setColor(new Color(180,0,0)) ); // outlines the face
       ...
       windmill.setColor(new Color(225,200,200)); // color for the pole
